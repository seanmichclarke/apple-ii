...
Per-slide outline for building or adjusting the deck in Keynote. `Applesoft_Loaded_Dice_EXPANDED.pptx` opens directly in Keynote; this file is the same content as text, with assets and sources per slide. Generated from `_build/build_new_deck.py`.

Palette: background `#17181A`, panels `#202225`, accent green `#5FCB7E`, text `#E9E7E3`, muted `#9DA39B`, highlight amber `#E0A73E`. Fonts: Arial, Courier New.

Main talk: slides 0–19. Backup: B1–B7.
...
**Source line:** Aldridge, Behavior Research Methods, Instruments, & Computers 19(4):397–399, 1987
...
**Source line:** Aldridge 1987; Ctrl-Reset behavior measured on the II Plus ROM warm-start path
...
## 4. Integer BASIC, 1977: seeded by you
...
**Source line:** Integer BASIC disassembly (Santa-Maria, via McFadden); Sander-Cederlof, AAL Aug 1981; Wozniak, BYTE May 1977; period measured by emulation
...
## 5. The entropy source is a busy-wait
...
**Assets:** `assets/keyin_orig_f8_fd1b.png`

**Source line:** 6502disassembly.com: OrigF8ROM, AutoF8ROM, Unenh_IIe_80col, IIc_16kb; Apple II Reference Manual p. 32
...
**Assets:** `assets/manual_rnd_positive.png`, `assets/manual_rnd_negative.png`, `assets/manual_rnd_zero.png`, `assets/screen_973136996.png`

**Source line:** Applesoft II BASIC Programming Reference Manual, Apple Computer (printing to confirm)
...
## 7. Applesoft II: Microsoft's RND
...
**Assets:** `assets/applesoft_rnd_efae.png`

**Source line:** Microsoft BASIC M6502 v1.1 source, github.com/microsoft/BASIC-M6502; 6502disassembly.com/a2-rom/Applesoft.html
...
**Source line:** II Plus ROM bytes; S-C DocuMentor; Sander-Cederlof, AAL May 1984; values from running the ROM code
...
## 9. Two published loops, one generator
...
**Source line:** Kaner & Vokey, MICRO June 1984; Sander-Cederlof, AAL May 1984; all 256 cold starts run on the II Plus ROM
...
## 10. A regression of the default
...
**Source line:** Microsoft m6502.asm (IFE REALIO-3); Steil, msbasic; ROM comparison of II Plus, IIe, enhanced IIe; Weyhrich, Apple II History ch. 16
...
## 13. Found, reported, worked around
...
**Source line:** Aldridge 1987 (Apple’s advice to the lab)
...
## 15. The fix: put the counter back
...
**Source line:** Jeff Robison, LC_Loader / Patch_lc; HFIND per S-C DocuMentor; byte search of the II Plus ROM
...
## 16. What the fix does, and doesn’t
...
**Source line:** Debian Security Advisory DSA-1571-1 (May 2008); ISO C, rand/srand
...
## B1. Backup: Applesoft RND, byte by byte
...
**Source line:** AppleWin Apple2_Plus.rom (SHA-1 33a24f54…); S-C DocuMentor labels, simplified
...
## B2. Backup: the constants, as actually read
...
**Source line:** ROM bytes; Microsoft m6502.asm (octal); decoded with exact rational arithmetic; emulation of the II Plus ROM
...
## B3. Backup: $CD on real hardware (to fill in)
...
## B4. Backup: patch compatibility (to fill in)
...
**Source line:** S-C DocuMentor; byte search and branch-target search of AppleWin Apple2_Plus.rom
...
## B6. Backup: Commodore, same generator, different integration
